...
export class DmFormUtils {

    constructor(private dmWebSocketService: DmWebSocketService) { }
    ...
    public generateInputsFromSchema(schema: Schema, nodeType: string, initialData?: any, columns?: 'search' | string[]): DmFormInputData[] {
        ...
        for (const varName of inputNameArray) {
            ...
            const toPush: DmFormInputData = this.getFormInputData(nodeSchema, nodeType, varName, !(columns === 'search'), initialData);
    ...
    public getFormChangedValues(inputs: DmFormInputData[]): any {
        const toSubmit: any = {};
    ...
    public getFormInputData(nodeSchema: NodeType, nodeType: string, varName: string, withValidation = true, initialData?: any): DmFormInputData {
        ...
        if (varSchema.validation && withValidation) {
            ...
            asyncValidators.push(new DmUniqueValidator(this.dmWebSocketService, nodeType, varName, initialData));
            }
